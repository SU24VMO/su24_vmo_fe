        ...
        <Formik
            ...
            validate={(values) => {
                ...
                if (!values.emailOrganize) {
                    ...
                    !/^[A-Z0-9._%+-]+@[A-Z0-9.-]+\.[A-Z]{2,}$/i.test(values.emailOrganize)
                ) {
                ...
                if (!values.emailPersonal) {
                    ...
                    !/^[A-Z0-9._%+-]+@[A-Z0-9.-]+\.[A-Z]{2,}$/i.test(values.emailPersonal)
                ) {
        ...
        >
            {({
                ...
                <form onSubmit={handleSubmit} class=" w-3/4 laptop:max-w-4xl mx-auto my-8">
                    ...
                    <div class="mb-5">
                        ...
                        <div class="relative w-full ">
                            ...
                            setFieldValue={setFieldValue}
                                popOverTriggerId="birthday"></BirthDayPicker>
                    ...
                    <div class="mb-5">
                        <label for="website"
                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Website hoặc trang tin điện tử</label>
                        <input type="text"
                            id="website"
                            name="website"
                            onChange={handleChange}
                            ...
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Website..."  />
                    </div>
                    <div class="mb-5">
                        <label for="fieldOfWork" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Lĩnh vực hoạt động chính *</label>
                        <input type="fieldOfWork"
                            id="fieldOfWork"
                            name="fieldOfWork"
                            onChange={handleChange}
                            onBlur={handleBlur}
                            value={values.fieldOfWork}
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="vd: Kinh doanh"  />
                    </div>
                    <div class="mb-5">
                    ...
                    <div class="mb-5">
                        <label for="emailOrganize" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white ">Email tài khoản người dùng của tổ chức trên ứng dụng VMO (tochucthiennguyen@gmail.com) *</label>
                        <input type="email"
                            id="emailOrganize"
                            name="emailOrganize"
                            onChange={handleChange}
                            onBlur={handleBlur}
                            value={values.emailOrganize}
                            autocomplete="off"
                        ...
                        <p class="mt-2 text-sm text-red-600 dark:text-red-500"> {errors.emailOrganize && touched.emailOrganize && errors.emailOrganize}</p>
                    ...
                    <div class="mb-5">
                        <label for="nameOfUser" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Họ và tên *</label>
                        <input type="text"
                            id="nameOfUser"
                            name="nameOfUser"
                            onChange={handleChange}
                            ...
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Nhập tên..."  />
                        <p class="mt-2 text-sm text-red-600 dark:text-red-500"> {errors.nameOfUser && touched.nameOfUser && errors.nameOfUser}</p>
                    ...
                    <div class="mb-5">
                        <label for="emailPersonal" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Email cá nhân *</label>
                        <input type="email"
                            id="emailPersonal"
                            name="emailPersonal"
                            onChange={handleChange}
                            ...
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="vd: tddkhoa0811@gmail.com -> email đã đăng ký trên hệ thống"  />
                        <p class="mt-2 text-sm text-red-600 dark:text-red-500"> {errors.emailPersonal && touched.emailPersonal && errors.emailPersonal}</p>
