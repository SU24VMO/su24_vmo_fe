  ...
  const updateActivity = async (data, resetForm, setSubmitting) => {
    ...
    try {
      const response = await axiosPrivate.put(
        UPDATEACTIVITY + `?createActivityRequestId=${id}`,
        formData,
        {
          headers: {
            "Content-Type": "multipart/form-data",
          ...
          {({
            ...
            <form onSubmit={handleSubmit}>
              <div
                ...
                tabIndex="-1"
                aria-hidden="true"
                className="justify-center items-center w-full h-modal"
              >
                <div className="p-4 mx-auto w-3/4 h-full tablet:h-auto animate-fadeInLeft">
                  <div className="p-4 bg-white rounded-lg shadow dark:bg-gray-800 mobile:p-5">
                    ...
                    <div>
                      <div className="grid gap-4 mb-4 grid-rows-1">
                        <div>
                          <label
                            htmlFor="title"
                        ...
                        <div>
                          ...
                          <p className="mt-2 text-sm text-red-600 dark:text-red-500">
                            {" "}
                            {errors.processingPhase &&
                              touched.processingPhase &&
                              errors.processingPhase}
                          </p>
                        </div>
                        <div>
                          <label
                            htmlFor="listImagesPreview"
                            className="block mb-2 text-sm font-medium text-gray-900 dark:text-white"
                          >
                            Danh sách hình ảnh:
                          </label>
                          <div>
                                ...
                                <div className="flex items-center justify-center w-full">
                                  ...
                                  >
                                    ...
                                    <input
                                      ...
                                      name="listImageFile"
                                      onChange={(e) => {
                                        fileSelectedHandler(e, setFieldValue);
                                      }}
                                    />
                                  </label>
                                </div>
                            ...
                            <p className="mt-2 text-sm text-red-600 dark:text-red-500">
                              {" "}
                              {errors.listImageFile &&
                                touched.listImageFile &&
                                errors.listImageFile}
                            </p>
                          </div>
                        </div>
