                    ...
                    <div class="flex items-start mb-5 flex-col">
                        ...
                        <div class="flex items-start mb-5 ">
                            <div class="flex items-center h-5">
                                <input id="founder" type="checkbox" value="" class="w-4 h-4 border border-gray-300 rounded bg-gray-50 focus:ring-3 focus:ring-blue-300 dark:bg-gray-700 dark:border-gray-600 dark:focus:ring-blue-600 dark:ring-offset-gray-800 dark:focus:ring-offset-gray-800" required />
                            </div>
                        ...
                        <div class="flex items-start mb-5 ">
                            ...
                            <div class="flex items-center h-5">
                                <input id="leader" type="checkbox" value="" class="w-4 h-4 border border-gray-300 rounded bg-gray-50 focus:ring-3 focus:ring-blue-300 dark:bg-gray-700 dark:border-gray-600 dark:focus:ring-blue-600 dark:ring-offset-gray-800 dark:focus:ring-offset-gray-800" required />
                            </div>
                            <label for="leader" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Chủ nhiệm</label>
                        </div>
                    </div>
                    <div class="mb-5">
                        <label for="nameOfClub" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Tên câu lạc bộ/đội/nhóm của bạn</label>
                        <input type="nameOfClub" id="nameOfClub" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required />
                    </div>
                    <div class="mb-5">
