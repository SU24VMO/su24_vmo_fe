...
export async function exportToExcelUserTransaction() {
  ...
  try {
    const response = await axiosPrivate.get(
      `/api/transaction/all/statement/receive-transaction`
    );
    ...
    // actions:"Xem ảnh"
        ...
        "Trạng thái ẩn danh" :banking?.isCognito === true ? "Ẩn danh" : "Không ẩn danh",
      ...
      let columns = [
        {
          ...
          columns: [
            ...
            { label: "Trạng thái ẩn danh", value: "Trạng thái ẩn danh" },
