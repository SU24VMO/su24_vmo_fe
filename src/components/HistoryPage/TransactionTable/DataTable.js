  ...
  <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
   <li>
      <div class="flex items-center">
        <a href="." class="ms-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ms-2 dark:text-gray-400 dark:hover:text-white">Trang cá nhân</a>
      </div>
    </li>
    <li aria-current="page">
      <div class="flex items-center">
        ...
        <span class="ms-1 text-sm font-medium text-gray-500 md:ms-2 dark:text-gray-400">Lịch sử giao dịch</span>
      </div>
    </li>
  </ol>
</nav>
      ...
      <div className="flex items-center py-4">
        <Input
          ...
          value={table.getColumn("receiverName")?.getFilterValue() || ""}
          onChange={(event) =>
